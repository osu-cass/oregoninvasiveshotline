...
processors.set_sentry_dsn(config, settings, traces_sample_rate=0.1) # type: ignore[arg-type] library autoinfers the type of traces_sample_rate as int, which is incorrect
