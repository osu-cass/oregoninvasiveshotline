...
- Do not run tests unless explicitly instructed to by the user
...
- While much of this project is unfortunatly untyped, new code should include types (but don't be overly verbose)